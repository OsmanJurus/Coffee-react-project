        ...
        <div className='flex mt-5 text-[#d9d9d9] bg-[#323232] flex-col items-center gap-5 pt-[40px] p-[20px, 8vw]' id='footer'>
            <div className='sm:grid flex flex-col gap-6 sm:grid-cols-[2fr,1fr,1fr] w-[100%] sm:gap-20'>
                <div className='flex flex-col items-start gap-5 ml-4'>
                    ...
                    <p>Indulge in a delightful culinary journey at Milgo, where every dish is crafted with passion and creativity.
                        Our menu is a celebration of flavors from around the world, combined with locally-sourced ingredients to ensure freshness and quality in every bite..</p>
